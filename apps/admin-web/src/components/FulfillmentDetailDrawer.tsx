...
import { Drawer, Descriptions, Divider, Empty, Image, Space, Spin, Tag, Timeline, Typography } from 'antd'
import { useQuery } from '@tanstack/react-query'
import { getOrder } from '../api/orders'
import { getWorkOrderTimeline, getWorkOrder, type AdminEvidence } from '../api/fulfillment'
...
export function FulfillmentDetailDrawer({ open, workOrderId, onClose }: { open: boolean; workOrderId?: string; onClose: () => void }) {
  ...
  return <Drawer title={work.data ? `履约详情 · ${work.data.workOrderNo}` : '履约详情'} open={open} onClose={onClose} width={1200}>
